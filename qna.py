...
def generate_qa_pairs(text, model, tokenizer, max_length=1024):
    ...
    result = ' '.join(first_500_words)
    new_text = " ".join(result.split())
...
folder_path = 'content/hw_troubleshoot/'
output_path = 'qna/hw_troubleshoot/'
