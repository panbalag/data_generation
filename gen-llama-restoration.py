...
def gen_content(name):
  ...
  prompt = 'Write a comprehensive hardware restoration guide for the fictional gaming system '+ name + 'focusing on patching and updates, hardware, software, sound and music restoration'
  ...
  file_path = "content/hw_restoration/" + file_name +".txt"  # You can change this to your desired file name or path
